...
| Goal034 — Automated black-box local stack acceptance | BLOCKED | Runtime-layout gate 7/7, три full verify и три standalone jar PASS; реальный LS/GS READY/registered, managed=10 и terminal/unique, но ACTIVE остаётся 2..3 вместо 5; native restart/gen2 не достигнуты, лимит 3 full verify исчерпан |
