...
3. **Goal036 — bounded whitelist quests + instances slice — `PLANNED`, `NOT_STARTED`.** Generic ограниченный lifecycle, class-transfer path и явно supported Kamaloka/Pailaka; без universal solver.
