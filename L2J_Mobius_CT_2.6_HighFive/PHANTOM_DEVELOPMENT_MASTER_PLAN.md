...
3. **Goal036 — bounded quests/instances slice — `PLANNED`, `NOT_STARTED`.** Generic whitelist lifecycle, class-transfer path, Kamaloka/Pailaka только в заявленном supported scope; не universal solver.
